...
template<int K>
class o1_spatial_gaussian_filter
{
private:
	int r;
...
public:
	o1_spatial_gaussian_filter(double sigma)
	{
		if(sigma<1.0)
...
template<> template<>
void o1_spatial_gaussian_filter<1>::filter_x<1>(int w,int h,double* src,double* dst)
{
	const int K=1,CH=1;
...
template<> template<>
void o1_spatial_gaussian_filter<2>::filter_x<1>(int w,int h,double* src,double* dst)
{
	const int K=2,CH=1;
...
template<> template<>
void o1_spatial_gaussian_filter<1>::filter_x<4>(int w,int h,double* src,double* dst)
{
	const int K=1,CH=4;
...
template<> template<>
void o1_spatial_gaussian_filter<2>::filter_x<4>(int w,int h,double* src,double* dst)
{
	const int K=2,CH=4;
...
void o1_spatial_gaussian_filter<1>::filter_y(int w,int h,double* src,double* dst)
{
	const int K=1;
...
template<> template<int CH>
void o1_spatial_gaussian_filter<2>::filter_y(int w,int h,double* src,double* dst)
{
	const int K=2;
